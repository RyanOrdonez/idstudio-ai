      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">IDStudio.ai</span>
            </div>
            <p className="text-neutral-400 mb-4 max-w-md">
              Empowering interior designers with AI-powered tools to streamline projects, manage clients, and bring creative visions to life.
            </p>
        ...
        <div className="border-t border-neutral-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-neutral-400 text-sm">
            © 2024 IDStudio.ai. All rights reserved.
          </p>
          <div className="flex items-center space-x-4 mt-4 md:mt-0">
            <span className="text-neutral-400 text-sm">Made with ❤️ for interior designers</span>
          </div>
        </div>
      </div>
    </footer>
