        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
              Have questions about IDStudio.ai? We&apos;d love to hear from you. 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-neutral-600">hello@idstudio.ai</p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-semibold text-neutral-900 mb-1">Live Chat</h3>
                      <p className="text-neutral-600">Available in-app</p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-semibold text-neutral-900 mb-1">Help Center</h3>
                      <p className="text-neutral-600">Self-service resources</p>
                      <p className="text-sm text-neutral-500">Guides, tutorials, and FAQs</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8">
                <h3 className="text-xl font-semibold text-neutral-900 mb-4">Our Office</h3>
                ...
                <div className="mt-6">
                  <p className="text-sm text-neutral-500">
                    We&apos;re a remote-first company, but love meeting designers in person at industry events!
                  </p>
                </div>
              </div>
            </div>
